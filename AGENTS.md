...
| ------------------- | ------------------- | ------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| `backend/`          | Django バックエンド | Python 3.13 · Django 5 · Channels · DRF · PostgreSQL 16 · Redis 7 · Nginx | [d-party-Backend](https://github.com/d-party/d-party-Backend)                     |
...
backend/
  ...
  Postgres/ Redis/ nginx/ prometheus/ grafana/   各サービス設定
```
